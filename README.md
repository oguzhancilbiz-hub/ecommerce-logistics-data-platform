...
models/
├── greenweez/
│   ├── staging/        # Veri temizleme (Casting & Renaming)
│   ├── intermediate/   # İş mantığı ve Join işlemleri
│   └── mart/finance/   # Raporlamaya hazır tablolar
└── Circle_parcel/
    └── staging/        # Lojistik verileri ön hazırlık
``` 
